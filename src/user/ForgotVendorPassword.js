...
class ForgotVendorPassword extends React.Component {
	constructor() {
        super();
        this.state = {
			email:'',
	...
	forgotVendorPassword = async (e) => {
        e.preventDefault();
        this.setState({ isLoading: true });
        const formDataSend = new FormData();
        formDataSend.append('type', this.state.acc_type);
        formDataSend.append('email', this.state.email);
        const res = await axios.post('api/auth/forgot_vendor_password', formDataSend);
			                            ...
			                            <div className="form-tab">
			                                ...
			                                <div className="tab-content">
			                                    <div className="tab-pane fade show active" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
			                                        ...
			                                        <form  method="post" onSubmit={this.forgotVendorPassword.bind(this)}>
