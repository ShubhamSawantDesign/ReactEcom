...
class Products extends React.Component {
    ...
    async getProductsData() {
        ...
        const response = await axios.get('/api/auth/get_products_data');
    ...
    async getTemplates() {
        const { match: { params } } = this.props;
        this.setState({ isLoading: true });
        const response = await axios.get(`/api/auth/get_templates/${params.id}`);
    ...
    render(){
        // console.log('test1',this.state.exhangerate);
        return(
            <div>
                <Navbar />
                    ...
                    <nav aria-label="breadcrumb" className="breadcrumb-nav mb-2">
                        <div className="container-fluid">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">{this.state.category_name}</li>
                            </ol>
                        </div>
                    </nav>
                            ...
                            <div className="toolbox">
                                ...
                                <div className="toolbox-center">
                                    <div className="toolbox-info">
                                        You searched for <span>{this.state.category_name}</span>
                                    </div>
                                </div>
                                        ...
                                        <div className="product product-7 text-center">
                                            ...
                                            <div className="product-body">
                                                <div className="product-cat">
                                                    <Link to="#">{templates.file_type}</Link><br/>
                                                    
                                                </div>
                                                <h3 className="product-title"><Link to={"../product_"+templates.id}>{templates.title}</Link></h3>
                                                <p style={{fontSize:"12px"}}>Product By: {templates.uploaded_by}</p>
                                                ...
                                                <div className="filter-price">
                                                    ...
                                                    <Range
                                                        ...
                                                        <output style={{ marginTop: "0px" }} id="output">
                                                            ...
                                                            {/* {this.state.cat_name === null || this.state.file_type === null ?
                                                            <div class="text-center"><a type="submit" class="btn btn-primary btn-shadow" onClick={()=>{
                                                                Swal.fire({
                                                                title: "Please select all!",
                                                                text: 'Please select all fields',
                                                                icon: "warning",
                                                            })
                                                        }}>Filter <i class="icon-long-arrow-right"></i></a></div>
                                                        : */}
