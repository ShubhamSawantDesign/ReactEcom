...
class Trending extends React.Component {
    ...
    async gettrendingdata() {
        ...
        const response = await axios.get('/api/auth/trending_data');
                    ...
                    <nav aria-label="breadcrumb" className="breadcrumb-nav mb-2">
                        <div className="container-fluid">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">Trending Digital Assets</li>
                            </ol>
                        </div>
                    </nav>
                            ...
                            <div className="toolbox">
                                ...
                                <div className="toolbox-center">
                                    <div className="toolbox-info">
                                        You searched for <span>Trending Digital Assets</span>
                                    </div>
                                </div>
                                    ...
                                    <div className="col-6 col-md-3 col-lg-3 col-xl-3 col-xxl-2 col-sm-6 mt-4">
                                        <div className="product product-7 text-center">
                                            ...
                                            <div className="product-body">
                                                ...
                                                <p to="#" style={{fontSize:"12px"}}>Product By: {templates.uploaded_by}</p>
                                                ...
                                                {this.state.filetype  && 
                                                    <div className="filter-items filter-items-count">
                                                        ...
                                                        <div className="filter-item">
                                                            ...
                                                            }} className="custom-control-input" id={"cat-"+filetypes.file_type+""} required/>
