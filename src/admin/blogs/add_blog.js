...
class AddBlog extends React.Component {
    ...
    AddBlog = async (e) => {
       ...
       fetch('https://data.artaux.io/api/admin_auth/add_blog?token='+ tk,{
            method:"POST",
            mode: 'no-cors',
            body:formData
        }).then((res)=>{
                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <div className="card card-primary">
                                        <form onSubmit={this.AddBlog.bind(this)} method="post" encType="multipart/form-data" id="template_form">
                                            <div className="card-body">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="input-group">
                                                        ...
                                                        <input type="file" className="custom-file-input" id="image" name="image" required onChange={(e) => {
                                            ...
                                            <div className="card-footer">
                                                <button type="submit" className="btn btn-primary ml-2">{this.state.isLoading ? <img src="/assets/images/frontend_images/ajax-loader.gif" alt="loading...." style={{height:'15px'}}/> : <i className="fa fa-check"></i>} Add Blog</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
