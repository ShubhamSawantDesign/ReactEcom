...
class newContributors extends React.Component {
    constructor() {
        super();
        this.state = {
            data: [],
    ...
    async getContributors() {
        ...
        const response = await axios.get('api/admin_auth/new_contributors?token='+ tk);
        if(response.data.contributors){
            ...
            this.props.history.push("../admin-new-contributors");
        }
    }
                            ...
                            <div className="row mb-2">
                                ...
                                <div className="col-sm-6">
                                    <ol className="breadcrumb float-sm-right">
                                        ...
                                        <li className="breadcrumb-item active">New Contributors</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="card">
                                        <div className="card-body" style={{overflow:"auto"}}>
                                            ...
                                            <table id="example" className="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th className="text-center">Contributor ID</th>
                                                ...
                                                {this.state.contributors.map(
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="text-center"><ModalImage
                                                        ...
                                                        <td className="text-center">
                                                            <a href={'admin-contributor_edit_'+contributors.id} className="btn btn-success btn-sm ml-1" title="Contributoe Edit"><i className="fas fa-pencil-square-o" title="Edit"></i></a>
                                                            <Popup trigger={<a href="#" className="btn btn-success btn-sm ml-1 m-1" title="Bank Details"><i className="fas fa-money-bill-wave"></i></a>} modal>
                                                                {this.state.accounts ?
                                                                <div>
                                                                ...
                                                                :<div>
                                                                    ...
                                                                    <hr></hr>
                                                                    <div className="row">
                                                                        <div className="col-md-12 text-center">Contributor dosen't added account details!</div>
                                                                    </div>
                                                                </div>}
                                                            </Popup>
                                                        </td>
