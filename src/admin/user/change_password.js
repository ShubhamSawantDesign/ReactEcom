...
class ChangePassword extends React.Component {
    ...
    ChangePassword = async (e) => {
        ...
        var id= JSON.parse(localStorage.getItem('sa_user')).id;
        var email= JSON.parse(localStorage.getItem('sa_user')).email;
        ...
        const res = await axios.post('api/admin_auth/change_password?token='+ tk, formData);
