...
class ViewCollectionBanners extends React.Component {
    ...
    async getBanners() {
        ...
        const response = await axios.get('api/admin_auth/view_collection_banners?token='+ tk);
                            ...
                            <div className="row mb-2">
                                ...
                                <div className="col-sm-6">
                                    <ol className="breadcrumb float-sm-right">
                                        ...
                                        <li className="breadcrumb-item active">Collection Banners</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
...
export default ViewCollectionBanners;